...
namespace CodeCelendar
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnDec08_02.Click += new System.EventHandler(this.btnDec08_02_Click);
            // 
            // btnDec08_01
            // 
            ...
            this.btnDec08_01.Click += new System.EventHandler(this.btnDec08_01_Click);
            // 
            // groupDec07
            // 
            ...
            this.btnDec10_02.Click += new System.EventHandler(this.btnDec10_02_Click);
            // 
            // btnDec10_01
            // 
            ...
            this.btnDec10_01.Click += new System.EventHandler(this.btnDec10_01_Click);
            // 
            // groupDec15
            // 
            ...
            this.btnDec15_02.Click += new System.EventHandler(this.btnDec15_02_Click);
            // 
            // btnDec15_01
            // 
            ...
            this.btnDec15_01.Click += new System.EventHandler(this.btnDec15_01_Click);
            // 
            // groupDec14
            // 
            ...
            this.btnDec14_02.Click += new System.EventHandler(this.btnDec14_02_Click);
            // 
            // btnDec14_01
            // 
            ...
            this.btnDec14_01.Click += new System.EventHandler(this.btnDec14_01_Click);
            // 
            // groupDec13
            // 
            ...
            this.btnDec13_02.Click += new System.EventHandler(this.btnDec13_02_Click);
            // 
            // btnDec13_01
            // 
            ...
            this.btnDec13_01.Click += new System.EventHandler(this.btnDec13_01_Click);
            // 
            // groupDec12
            // 
            ...
            this.btnDec11_02.Click += new System.EventHandler(this.btnDec11_02_Click);
            // 
            // btnDec11_01
            // 
            ...
            this.btnDec11_01.Click += new System.EventHandler(this.btnDec11_01_Click);
            // 
            // groupDec20
            // 
        ...
        {
            IDataInput dataInput = new FileInput(@"day07.txt", ",");
            string[] output = dataInput.GetData();
        ...
        private void btnDec10_01_Click(object sender, EventArgs e)
        {
            IDataInput dataInput = new FileInput(@"day10.txt");
            string[] output = dataInput.GetData();
            Day10 day = new Day10(output);
            txtDec10_01.Text = day.GetResultsPart1();
        }

        private void btnDec10_02_Click(object sender, EventArgs e)
        {
            IDataInput dataInput = new FileInput(@"day10.txt");
            string[] output = dataInput.GetData();
            Day10 day = new Day10(output);
            txtDec10_02.Text = day.GetResultsPart2();
        }

        private void btnDec11_01_Click(object sender, EventArgs e)
        {
            IDataInput dataInput = new FileInput(@"day11.txt");
            string[] output = dataInput.GetData();
            Day11 day = new Day11(output);
            txtDec11_01.Text = day.GetResultsPart1();
        }

        private void btnDec11_02_Click(object sender, EventArgs e)
        {
            IDataInput dataInput = new FileInput(@"day11.txt");
            string[] output = dataInput.GetData();
            Day11 day = new Day11(output);
        ...
        private void btnDec13_01_Click(object sender, EventArgs e)
        {
            IDataInput dataInput = new FileInput(@"day13.txt");
            string[] output = dataInput.GetData();
            Day13 day = new Day13(output);
            txtDec13_01.Text = day.GetResultsPart1();
        }

        private void btnDec13_02_Click(object sender, EventArgs e)
        {
            IDataInput dataInput = new FileInput(@"day13.txt");
            string[] output = dataInput.GetData();
            Day13 day = new Day13(output);
            txtDec13_02.Text = day.GetResultsPart2();
        }

        private void btnDec14_01_Click(object sender, EventArgs e)
        {
            IDataInput dataInput = new FileInput(@"day14.txt");
            string[] output = dataInput.GetData();
            Day14 day = new Day14(output);
            txtDec14_01.Text = day.GetResultsPart1();
        }

        private void btnDec14_02_Click(object sender, EventArgs e)
        {
            IDataInput dataInput = new FileInput(@"day14.txt");
            string[] output = dataInput.GetData();
        ...
        private void btnDec15_01_Click(object sender, EventArgs e)
        {
            IDataInput dataInput = new FileInput(@"day15.txt");
            string[] output = dataInput.GetData();

            Day15 day = new Day15(output);
            txtDec15_01.Text = day.GetResultsPart1();
        }

        private void btnDec15_02_Click(object sender, EventArgs e)
        {
            IDataInput dataInput = new FileInput(@"day15.txt");
            string[] output = dataInput.GetData();
